...
botui.message
  ...
  .then(function () {
    return botui.message.add({
      ...
      loading: true,
      content:
        "This is Planet vital  CoronaVirus (COVID-19) Helpdesk to create awareness and self assessment scan has been developed on the basis of guideliness from the CDC(. This interaction should not be taken as expert medical advice. Any information you share with us will be kept strictly confidential.",
    });
  });
    ...
    .then(function (res) {
      ...
      if (res.value === "selfas") {
        ...
        return botui.message
          ...
          .then(function () {
            botui.message.add({
              ...
              loading: true,
              content:
                "Call 911 - You may be having a medical emergency.Call 911 now. Immediate medical attention is needed. Tell the 911 operator if you have been in contact with someone with COVID-19 or if you have recently been to an area where COVID-19 is spreading.",
            });
            options();
          });
        ...
        function Initialise_chat() {
          ...
          fetch(
            "https://loopback-bot-dialogflow.holaa.ai/dialogflowapi/gettoken",
            requestOptions
          )
            .then((response) => response.json())
            .then((result) => {
              token_for_query = result.token;
              Qn("hi");
            })
        ...
        async function Qn(a) {
          ...
          var raw = JSON.stringify({
            queryInput: { text: { text: a, languageCode: "en" } },
          });
          ...
          var rslt = await fetch(
            "https://dialogflow.googleapis.com/v2beta1/projects/planervitals-nbuvgy/agent/sessions/12345:detectIntent",
            requestOptions
          )
            .then((response) => response.json())
            .then((result) => {
